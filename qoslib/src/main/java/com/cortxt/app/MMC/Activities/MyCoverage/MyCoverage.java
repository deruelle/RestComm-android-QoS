...
import com.cortxt.app.MMC.ActivitiesOld.CustomViews.Fragments.EventHistoryFragment;
...
//	};
	...
	android.view.View.OnClickListener indoorMapping = new android.view.View.OnClickListener() {

		@Override
		public void onClick(View v) {
			Intent intent = new Intent(MyCoverage.this, ManualMapping.class);
			intent.putExtra("type", MmcConstants.MANUAL_SEARCHING);
			startActivity(intent);
			if(coverageMenu!=null){
				coverageMenu.dismissWindow();
			}
...
//			View seperator4 = (View)menuOptionsView.findViewById(R.id.Separator4);
			TextView indoorMappingOption = (TextView)menuOptionsView.findViewById(R.id.IndoorMappingOption);
			View seperator5 = (View)menuOptionsView.findViewById(R.id.Separator5);
...
//			if(true) { //TODO: remove after testing
				...
				//outdoor mapping
//				outdoorMappingOption.setVisibility(View.GONE);
//				seperator4.setVisibility(View.GONE);
				//outdoorMappingOption.setOnClickListener(outdoorMapping);	
				//indoor mapping
				indoorMappingOption.setVisibility(View.VISIBLE);
				seperator5.setVisibility(View.VISIBLE);
				indoorMappingOption.setOnClickListener(indoorMapping);	
			}	
