...
public class DeveloperScreenOld extends MMCActivity {
   ...
   */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(view);
        MMCActivity.customizeTitleBar (this,view,R.string.GenericText_Log, R.string.GenericText_Log);
		...
		tags.add(TrackingManagerOld.TAG + ":*");
	...
	class ReadLogThreadRunnable implements Runnable {
		 ...
		 * it only outputs the first {@link MAX_SIZE_LOG_BUFFER}
		 */
