 ...
 *
 */
public class EventOld implements IEvent {
	/*
	 * Private variables
	 */
	 ...
	 * Constructors
	 */
	public EventOld(EventType eventType, long eventTimestamp, long duration, Uri uri, Runnable onUnstage)  {
	...
	public EventOld(EventType eventType, long eventTimestamp, long duration) {
		this(eventType, eventTimestamp, duration, null, null);
	}
	public EventOld(EventType eventType, long duration){
		this(eventType, System.currentTimeMillis(), duration);
		setEventTimestampToNow();
	}
	public EventOld (EventType eventType, Uri uri){
		this(eventType, 0);
		this.uri = uri;
	}
	public EventOld (EventType eventType, Uri uri, long timestamp){
		this(eventType, timestamp, 0);
		this.uri = uri;
	}
	public EventOld(EventType eventType){
		this(eventType, 0);
	}
	
	public EventOld(String newAppData) {
	...
	public void setVideoResult(int playDelay, int accessDelay, int videoBytes, int _stalls, int _stallTime, String videoUrl, int videoHeight, int downloadDuration, int bufferPercent, int error, JSONObject resolutions) {
		...
		this.downloadSpeed = videoBytes*1000 / ((downloadDuration+accessDelay) / 1000);
	...
	public MMCSignalOld getSignal() {
		return signal;
	}
	public void setSignal(MMCSignalOld signal) {
		this.signal = signal;
	}
	public MMCCellLocationOld getCell() {
		return cell;
	}
	public void setCell(MMCCellLocationOld cell) {
		this.cell = cell;
	}
