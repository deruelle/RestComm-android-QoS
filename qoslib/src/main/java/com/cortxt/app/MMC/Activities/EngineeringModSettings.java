...
//	CheckBox remoteTesting = null;
	...
	public void startClicked(View button) {
		...
		MMCService.startDriveTest(this, numFiveMinutePeriodsToTrack*5, coverage, speedInterval, connectInterval,
...
//		spinner4.setSelection(0);
		...
		if (videoUrl == null || videoUrl.length() == 0 || !MMCCommand.isEventPermitted(this, EventType.VIDEO_TEST, 1))
		{
			// Video Test disabled
		...
		if (youtubeId == null || youtubeId.length() == 0 || !MMCCommand.isEventPermitted(this, EventType.YOUTUBE_TEST, 1))
		{
			// Video Test disabled
        ...
        if (audioUrl == null || audioUrl.length() == 0 || !MMCCommand.isEventPermitted(this, EventType.AUDIO_TEST, 1))
        {
            // Audio Test disabled
        ...
        if (webUrl == null || webUrl.length() == 0 || !MMCCommand.isEventPermitted(this, EventType.WEBPAGE_TEST, 1))
        {
