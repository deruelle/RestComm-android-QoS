...
public class ConnectionHistory {
		...
		//if (!_isTravelling)
		{
			...
			if (serviceState != null)
			{
				...
				if (serviceState.getRoaming() == true)
					smp.serviceState += 10;
				smp.voiceType = MMCPhoneStateListenerOld.getVoiceNetworkType(serviceState);
			}
			switch (activity)
			{
	...
	public String getHistory (long startTime, long eventTime, long endTime, EventOld evt)
	{
		int i;
	...
	public class ConnectionSample
	{
		...
		public String getStateName (EventOld evt)
		{
		...
		public String getActivityName (EventOld evt)
		{
			if (type >= TYPE_SPECIAL)
			{
				if (type == TYPE_VIDEO)	
