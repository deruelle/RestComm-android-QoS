 ...
 * @author abhin
 */
public class MMCCellLocationOld {
	private CellLocation cellLoc;
	private long cellIdTimestamp;
	private static Method getPscMethodPointer;
	private static final String TAG = MMCCellLocationOld.class.getSimpleName();
	...
	public MMCCellLocationOld(CellLocation cellLoc, long cellIdTimestamp){
		this.cellIdTimestamp = cellIdTimestamp;
		this.cellLoc = cellLoc;
	}
	public MMCCellLocationOld(CellLocation cellLoc){
		this.cellLoc = cellLoc;
