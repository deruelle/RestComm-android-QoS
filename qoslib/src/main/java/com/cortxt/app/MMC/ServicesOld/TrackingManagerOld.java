 ...
 * @author nasrullah
 */
public class TrackingManagerOld {
	public static final String TAG = TrackingManagerOld.class.getSimpleName();
	...
	public TrackingManagerOld(MMCService owner) {
		this.owner = owner;
	}
	...
	public void startCoverageTracking (int numFiveMinutePeriods)
	{
		...
		Intent intent = new Intent(MMCIntentHandlerOld.ACTION_TRACKING_5MINUTE);
...
//			PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_COVERAGE_INTERVAL, 0).commit();
//			PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_SPD_INTERVAL, 0).commit();
//			PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_VIDEO_INTERVAL, 0).commit();
//			PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_SMS_INTERVAL, 0).commit();
//			PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_CONNECT_INTERVAL, 0).commit();
//			PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_WEB_INTERVAL, 0).commit();
//			PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_VQ_INTERVAL, 0).commit();
//            PreferenceManager.getDefaultSharedPreferences(owner).edit().putInt(PreferenceKeys.Miscellaneous.TRACKING_AUDIO_INTERVAL, 0).commit();
            ...
            //intent = new Intent(MMCIntentHandlerOld.ACTION_TRACKING_1MINUTE);
            //PendingIntent alarm1min = PendingIntent.getBroadcast( owner, 0, intent, PendingIntent.FLAG_ONE_SHOT);
            //alarmMgr.cancel( alarm1min );
		}catch (Exception e)
		{
