...
public class EventDataEnvelope {
	...
	public EventDataEnvelope(int qOSRating, int iConnectTime, int v, int bDropped,
        ...
        if (context != null)
        {
            ...
            if (altLabel != null && !altLabel.equals(""))
                ...
                this.oCallData.appName = context.getString(R.string.app_label);
        }
	...
	public int getDataSpeed() {
		return oCallData.dataSpeed;
	}
	public void setDataSpeed(int dataSpeed) {
		oCallData.dataSpeed = dataSpeed;
	}
	*/
	public int getiUser() {
	...
	/*
	public int getiHandsetId() {
		return oCallData.iHandsetId;
	}
	public void setiHandsetId(int iHandsetId) {
		oCallData.iHandsetId = iHandsetId;
	}
	public int getiCarrierId() {
		return oCallData.iCarrierId;
	}
	public void setiCarrierId(int iCarrierId) {
		oCallData.iCarrierId = iCarrierId;
	}
	
	public String getTxtPhoneNumber() {
		return oCallData.txtPhoneNumber;
	}
	public void setTxtPhoneNumber(String txtPhoneNumber) {
		oCallData.txtPhoneNumber = txtPhoneNumber;
	}
	public int getBat() {
		return oCallData.bat;
	}
