 ...
 *
 */
public class EventCoupleOld {
	/*
	 * private variables
	 */
	private EventOld startEvent;
	private EventOld stopEvent;
	 ...
	 */
	public EventCoupleOld(EventType startEventType, EventType stopEventType, Uri eventCoupleUri, Uri startEventUri)
	{
		this(startEventType, stopEventType, eventCoupleUri, startEventUri, System.currentTimeMillis());
	}
	public EventCoupleOld(EventType startEventType, EventType stopEventType, Uri eventCoupleUri, Uri startEventUri, long time)
	{
		
		this.startEvent = new EventOld(startEventType, startEventUri, time);
		this.stopEvent = new EventOld(stopEventType);
	...
	public EventOld getStartEvent(){
		return this.startEvent;
	}
	
	public EventOld getStopEvent(){
