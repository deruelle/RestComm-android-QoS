...
public class SpeedStatGroupView extends StatViewNew {

	private static final String TAG = SpeedStatGroupView.class.getSimpleName();
	private LegendViewNew legendView;
	private ProgressDialog progressDialog;

	public SpeedStatGroupView(Context context) {
		super(context);
		this.context = context;
		init();
	}

	public SpeedStatGroupView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init();
	}
	...
	public void init() {
		...
		// TODO draw page title
		
		Log.e("<<<<", "SpeedStatGroupView.init()");
