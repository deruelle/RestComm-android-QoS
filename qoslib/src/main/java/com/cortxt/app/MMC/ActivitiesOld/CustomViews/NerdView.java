...
//		}
	...
	public void nerdOut (TelephonyManager telephonyManager){
		...
		networkTier = MMCPhoneStateListenerOld.getNetworkGeneration(networkType);
		String nettype = MMCPhoneStateListenerOld.getNetworkName (telephonyManager.getNetworkType());
		String data = MMCPhoneStateListenerOld.getNetworkName (telephonyManager.getNetworkType()) + " ";
...
//	}
	...
	public String getServiceStateName (int state)
	{
		...
		case ServiceState.STATE_EMERGENCY_ONLY:
			name += "(911 only)"; break;
		case MMCPhoneStateListenerOld.SERVICE_STATE_AIRPLANE:
			name += "(airplane)"; break;
